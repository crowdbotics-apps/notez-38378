"""
Django settings for notez_38378 project.
...
WSGI_APPLICATION = 'notez_38378.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "notez_38378 API",
    "DESCRIPTION": "API documentation for notez_38378 App",
    "VERSION": "v1",
}
